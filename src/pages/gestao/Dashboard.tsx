  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
        <Card className="bg-card border-border"><CardContent className="p-4"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center"><ClipboardList className="w-5 h-5 text-primary" /></div><div><p className="text-2xl font-heading text-foreground">{myOrders.length}</p><p className="text-xs text-muted-foreground font-normal">Total Pedidos</p></div></div></CardContent></Card>
        <Card className="bg-card border-border"><CardContent className="p-4"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-yellow-500/10 flex items-center justify-center"><ShoppingCart className="w-5 h-5 text-yellow-500" /></div><div><p className="text-2xl font-heading text-foreground">{pendingOrders}</p><p className="text-xs text-muted-foreground font-normal">Pendentes</p></div></div></CardContent></Card>
        <Card className="bg-card border-border"><CardContent className="p-4"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-blue-500/10 flex items-center justify-center"><Package className="w-5 h-5 text-blue-500" /></div><div><p className="text-2xl font-heading text-foreground">{preparingOrders}</p><p className="text-xs text-muted-foreground font-normal">Em Preparação</p></div></div></CardContent></Card>
        <Card className="bg-card border-border"><CardContent className="p-4"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-green-500/10 flex items-center justify-center"><TrendingUp className="w-5 h-5 text-green-500" /></div><div><p className="text-2xl font-heading text-foreground">€{totalValue.toFixed(0)}</p><p className="text-xs text-muted-foreground font-normal">Valor Total</p></div></div></CardContent></Card>
        <Card className="bg-card border-border"><CardContent className="p-4"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center"><Clock className="w-5 h-5 text-primary" /></div><div><p className="text-2xl font-heading text-foreground">{todayOrders.length}</p><p className="text-xs text-muted-foreground font-normal">Hoje</p></div></div></CardContent></Card>
        <Card className="bg-card border-border"><CardContent className="p-4"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-green-500/10 flex items-center justify-center"><Truck className="w-5 h-5 text-green-500" /></div><div><p className="text-2xl font-heading text-foreground">{readyOrders}</p><p className="text-xs text-muted-foreground font-normal">Prontos</p></div></div></CardContent></Card>
      </div>
        ...
        <div className="space-y-4">
          {isWarehouse && stockAlerts.length > 0 && (
            <Card className="bg-card border-border border-yellow-500/20">
              <CardHeader><CardTitle className="text-sm font-heading tracking-wide flex items-center gap-2"><AlertTriangle className="w-4 h-4 text-yellow-500" /> Alertas de Stock</CardTitle></CardHeader>
              <CardContent className="space-y-2">
                ...
                <Link to="/gestao/inventario" className="text-xs text-primary hover:underline flex items-center gap-1 mt-2 font-normal">Ver inventário <ArrowUpRight className="w-3 h-3" /></Link>
              </CardContent>
            </Card>
          )}

          <Card className="bg-card border-border">
            <CardHeader><CardTitle className="text-sm font-heading tracking-wide">Pedidos por Secção</CardTitle></CardHeader>
            <CardContent className="space-y-2">
          ...
          {isAdmin && (
            <Card className="bg-card border-border">
              <CardHeader><CardTitle className="text-sm font-heading tracking-wide">Resumo do Sistema</CardTitle></CardHeader>
